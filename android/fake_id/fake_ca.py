...
# by retme
#
# Replace ca in SIGN.RSA with certifcate in CERT.RSA
# and write result to final.rsa
#
...
if __name__ == "__main__" :
        ...
        sig,cert = get_cert_from_content("./CERT.RSA",0)
        
        #buff = cert_from_content("/home/retme/Desktop/SIGN.RSA",cert,1,sig)
        buff = cert_from_content("./SIGN.RSA",cert,1,None)
